...
public class Configuration {
	...
	public static final String DEVICE_GPONE      = "gp-one";
	...
	public static String getDeviceType() {
        ...
        else if ((new File("/sys/class/rfkill/rfkill1/state")).exists() == true
                && (new File("/system/etc/wifi/fw/athwlan.bin.z77")).exists() == true){
            return DEVICE_GPONE;
        }
